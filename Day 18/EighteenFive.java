...
class EighteenFive {
    ...
    public static void main(String[] args) {
        ...
        while (left <= right) {
            ...
            TreeSet<String> corruptedPositions = getCorruptedPositions(mid);

            if (calculateShortestDistance(corruptedPositions) == -1) {
                byteWhichPreventsExit = splitInput[mid - 1];
                right = mid - 1;
            } else {
                left = mid + 1;
            }
        ...
        // TreeSet<String> validatedCorruptedPositions = getCorruptedPositions(mid);
