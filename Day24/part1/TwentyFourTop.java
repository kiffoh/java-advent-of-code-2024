...
class TwentyFourTop {
    ...
    public static void initialiseWires(String[] initialValues, String[] gateRelationships) {
        ...
        getAllKnownWires();
        boolean knownAreInitial = knownWires.size() == initialValues.length;
        System.err.println("knownWires is same as initial wires: " + knownAreInitial);
    }
    ...
    public static Integer AND(Integer num1, Integer num2) {
        System.err.println("NEW VERSION OF AND");
        int result = (Integer.valueOf(1).equals(num1) && Integer.valueOf(1).equals(num2)) ? 1 : 0;
        System.err.println("AND(" + num1 + ", " + num2 + ") = " + result);
        return result;
    }
    public static Integer OR(Integer num1, Integer num2) {
        System.err.println("OR HIT");
    ...
    public static Integer XOR(Integer num1, Integer num2) {
        System.err.println("XOR HIT");
        return (!Objects.equals(num1, num2)) ? 1 : 0;
    }

    public static void initialiseFunctions() {
        functions.put("AND", TwentyFourTop::AND);
        functions.put("OR", TwentyFourTop::OR);
        functions.put("XOR", TwentyFourTop::XOR);
    }
    ...
    public static void calculateValue(Wire wire) {
        ...
        if (func.equals("AND")) {
            System.err.println("Calculating: " + parent1.name + " " + func + " " + parent2.name + " -> " + wire.name);
            System.err.println("  Values: " + parent1.value + " " + func + " " + parent2.value);
            System.err.println("  Result: " + wire.value);
        }
